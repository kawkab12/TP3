...
public final class BankserviceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = ma.ahmed.stubs.Banc.ConvertcurrentRequest.class,
      responseType = ma.ahmed.stubs.Banc.ConvertcurrentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest, ma.ahmed.stubs.Banc.ConvertcurrentResponse> getConvertMethod;
    if ((getConvertMethod = BankserviceGrpc.getConvertMethod) == null) {
      synchronized (BankserviceGrpc.class) {
        if ((getConvertMethod = BankserviceGrpc.getConvertMethod) == null) {
          BankserviceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<ma.ahmed.stubs.Banc.ConvertcurrentRequest, ma.ahmed.stubs.Banc.ConvertcurrentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Bankservice", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.ahmed.stubs.Banc.ConvertcurrentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.ahmed.stubs.Banc.ConvertcurrentResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getGetCurrentStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getGetCurrentStreamMethod() {
    io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest, ma.ahmed.stubs.Banc.ConvertcurrentResponse> getGetCurrentStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest, ma.ahmed.stubs.Banc.ConvertcurrentResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getFullCurrentStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest,
      ma.ahmed.stubs.Banc.ConvertcurrentResponse> getFullCurrentStreamMethod() {
    io.grpc.MethodDescriptor<ma.ahmed.stubs.Banc.ConvertcurrentRequest, ma.ahmed.stubs.Banc.ConvertcurrentResponse> getFullCurrentStreamMethod;
  ...
  public static abstract class BankserviceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(ma.ahmed.stubs.Banc.ConvertcurrentRequest request,
        io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getCurrentStream(ma.ahmed.stubs.Banc.ConvertcurrentRequest request,
        io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentRequest> performStream(
        io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentRequest> fullCurrentStream(
        io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ma.ahmed.stubs.Banc.ConvertcurrentRequest,
                ma.ahmed.stubs.Banc.ConvertcurrentResponse>(
  ...
  public static final class BankserviceBlockingStub extends io.grpc.stub.AbstractStub<BankserviceBlockingStub> {
     ...
     * </pre>
     */
    public ma.ahmed.stubs.Banc.ConvertcurrentResponse convert(ma.ahmed.stubs.Banc.ConvertcurrentRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ma.ahmed.stubs.Banc.ConvertcurrentResponse> getCurrentStream(
        ma.ahmed.stubs.Banc.ConvertcurrentRequest request) {
  ...
  public static final class BankserviceFutureStub extends io.grpc.stub.AbstractStub<BankserviceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ma.ahmed.stubs.Banc.ConvertcurrentResponse> convert(
        ma.ahmed.stubs.Banc.ConvertcurrentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((ma.ahmed.stubs.Banc.ConvertcurrentRequest) request,
              (io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENT_STREAM:
          serviceImpl.getCurrentStream((ma.ahmed.stubs.Banc.ConvertcurrentRequest) request,
              (io.grpc.stub.StreamObserver<ma.ahmed.stubs.Banc.ConvertcurrentResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankserviceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ma.ahmed.stubs.Banc.getDescriptor();
    }
